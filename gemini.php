...
$systemInstruction = "על התשובה להיות בעברית בלבד.הפעל שיקול דעת לגבי אורך התשובה"+"אם אתה מקבל את פרטי הדף הנוכחי של המשתמש אל תתיחס אליהם ללא הוראה מפורשת כגון סכם דף זה/תרגם דף זה";
